...
if (isset($_POST['end_semester'])) {
    $sql2 = "SELECT COUNT(*) as count, se_id FROM studen WHERE se_id = 5";
    ...
    if ($count > 0) {
        ...
        $sql3 = "UPDATE studen SET se_id = '$n_sem' WHERE se_id = 5";
...
<section id="content">
    ...
    <h2 class="section-title">
        <span style="float: left;">
            <button class="add-student-button"><a href="<?php echo SIT; ?>admin/ST-form.php?se_id=5" class="button-link">Add Student</a></button>
        </span>
        Semester 5
        ...
        <div class="dashboard-content">
            ...
            <table class="student-table">
                ...
                <tbody>
                        ...
                        <?php
                        $sql = "SELECT * FROM studen where se_id='5' ";
